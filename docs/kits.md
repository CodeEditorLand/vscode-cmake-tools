...
An example of when a project-local kit is useful is when the project defines its
...
See [Configure CMake](configure.md) for more information about how kits are
