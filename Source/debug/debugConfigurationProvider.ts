	...
	implements vscode.DebugConfigurationProvider
{
	resolveDebugConfiguration(
		...
		if (debugConfiguration.cmakeDebugType === undefined) {
			...
			if (
				debugConfiguration.cmakeDebugType === "external" &&
				debugConfiguration.pipeName === undefined
			) {
				throw new Error(
					localize(
				...
				debugConfiguration.cmakeDebugType === "script" &&
				!(
					debugConfiguration.scriptPath.endsWith(".cmake") ||
					(debugConfiguration.scriptPath === "${file}" &&
